...
Expect.pm (1.01) - Perl Expect interface
...
would be obsolete anyway given the advent of Socket.pm and external tools
such as netcat.

Expect.pm is an attempt to have more of a switch() & case: feel to make 
decision processing more fluid. Two separate types of debugging have 
...
5 POSIX.pm module. The Fcntl.pm module is also used.
